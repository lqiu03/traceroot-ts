...
export interface InitializeOptions {
  ...
  instrumentModules?: {
     ...
     *
     * PII / CONTENT CAPTURE: this accepts only the bare module ref — there is
     * no `{ module, config }` wrapper and no capture toggle. Prompt
     * input/output and tool I/O are captured unconditionally onto every
     * AGENT/LLM/TOOL span this instrumentation emits, with no way to opt out
